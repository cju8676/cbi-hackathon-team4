...
import coronaPic from './images/coronabeachcity.png';
import modeloPic from './images/modelosports.png';
import robertmondaviPic from './images/robertmondavi.png';
import coronaLogo from './logos/corona.png';
import modeloLogo from './logos/modelo.png';
import robertmondaviLogo from './logos/robertmondavi.png';
...
const modeloProf = {
    ...
    profile: "modelousa",
    location: "Rochester, NY",
    caption: "Different Stories, United by Modelo",
    profPic: modeloLogo
}
const robertProf = {
    name: "Robert Mondavi",
    profile: "robertmondavi",
    location: "Rochester, NY",
    caption: "Robert Mondavi - Crafted Harmony.",
    profPic: robertmondaviLogo
}

export default function Instagram({ image, loading }) {
    const [curImg, setCurImg] = useState(coronaPic);
    const [curProfile, setCurProfile] = useState(coronaProf);
    ...
    useEffect(() => {
        ...
        switch (image) {
            case "corona":
                setCurImg(coronaPic);
                setCurProfile(coronaProf);
                break;
            case "modelo":
                setCurImg(modeloPic);
                setCurProfile(modeloProf);
                break;
            case "robertmondavi":
                setCurImg(robertmondaviPic);
                setCurProfile(robertProf);
                break;
            default:
                setCurImg(coronaPic);
                setCurProfile(coronaProf);
            ...
            <div class="container">
                <div class="col-9">
                    <div class="card">
                            ...
                            <div class="userDetails">
                                <div class="profilepic">
                                    <div class="profile_img">
                                        <div class="image">
                                            <img src={curProfile.profPic} />
                                        </div>
                                    </div>
                                </div>
                                <h3>{curProfile.profile}<br />
                                    <span>{curProfile.location}</span>
                                </h3>
                            </div>
                            <div>
                                <span class="dot">
                        ...
                        <div class="imgBx">
                            {loading ? <CircularProgress /> : <img src={curImg} alt="post-1"
                                class="cover" />}
                        </div>
                        <div class="bottom">
                            ...
                            <a href="#">
                                <p class="message">
                                    <b>{curProfile.profile}</b> {curProfile.caption}
                                </p>
                            </a>
                            <a href="#">
